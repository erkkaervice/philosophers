...
run_full()
{
	...
	' .julesphilo2log)
	if [[ ! $philo =~ ^[0-9]+$ ]] || [[ ! $time_eat =~ ^[0-9]+$ ]] || [[ ! $time_sleep =~ ^[0-9]+$ ]] || [[ ! $eat =~ ^[0-9]+$ ]] || [[ ! $forks =~ ^[0-9]+$ ]]; then
		echo -n "❌"
		echo -e "$test_desc: Input error: Non numerical\n" >> philo_trace
	elif [[ ! $forks =~ ^[0-9]+$ ]]; then
		echo -n "❌"
...
echo -e "${WHITE}BASIC ERROR TESTS\n${RESET}"
...
run_err "-5 600 200 200" -5 600 200 200
run_err "4 -5 200 200" 4 -5 200 200
run_err "4 600 -5 200" 4 600 -5 200
run_err "4 600 200 -5" 4 600 200 -5
run_err "4 600 200 200 -5" 4 600 200 200 -5
...
echo -e "\n\n${WHITE}PHILOS SHOULD SURVIVE: Small\n${RESET}"
echo -e "-- SMALL NO DEATH TESTS --\n" >> philo_trace
...
run_full "10 500 100 100 20" 10 500 100 100 50
run_full "11 900 150 90 20" 11 900 150 90 20
run_full "3 1000 300 200 5" 3 1000 300 200 5

rm -rf .julestestout .julesphilo1log .julesphilo2log

echo -e "\n\n${WHITE}PHILOS SHOULD SURVIVE: Large\n${RESET}"
echo -e "-- LARGE NO DEATH TESTS --\n" >> philo_trace

run_large "111 410 100 100 5" 111 410 100 100 5
run_large "112 210 100 100 5" 112 210 100 100 5
run_large "200 410 200 200 5" 200 410 200 200 5
run_large "199 610 200 200 5" 199 610 200 200 5

rm -rf .julestestout .julesphilo1log .julesphilo2log

# Run tests where a philosopher should die.

echo -e "\n\n${WHITE}PHILO SHOULD DIE 🪦\n${RESET}"
echo -e "-- Death Tests --\n" >> philo_trace
...
run_death "1 800 200 200 3" 1 800 200 200 3
run_death "4 310 200 100 3" 4 310 200 100 3
run_death "4 200 205 200 3" 4 200 205 200 3
run_death "10 199 100 100 10" 10 199 100 100 10
run_death "200 190 100 100 10" 200 190 100 100 10
run_death "199 290 100 100 10" 199 290 100 100 10
echo -e "\n"
