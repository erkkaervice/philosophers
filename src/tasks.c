...
/*   Updated: 2025/04/09 12:34:16 by eala-lah         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*
 * ft_time - Returns the current time in milliseconds since the simulation start.
 *
 * This function retrieves the current time using `gettimeofday`, calculates 
 * the time in milliseconds, and returns it. The time is used to track how 
 * long the philosophers have been running and to control their behavior
 * (eating, sleeping, etc.).
 *
 * Returns:
